...
class CompilationEngine:
    ...
    # def compile_subroutine_call(self, out_vm, tokens): TODO
    #     if tokens[1][1].strip() == "." and self.tables.index_of(tokens[0][1].strip()) is not None:
    #         sub_name = VMWriter.write_function(f"{tokens[0][1].strip()}.{tokens[2][1].strip()}")
    #     elif tokens[1][1].strip() == ".":
